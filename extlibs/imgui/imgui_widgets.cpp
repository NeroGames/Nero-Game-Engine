...
bool ImGui::ColorEdit4(const char* label, float col[4], ImGuiColorEditFlags flags)
{
    ...
    if (!(flags & ImGuiColorEditFlags_NoSmallPreview))
    {
        ...
        IMGUI_COLOR_PICKER_OPEN =  BeginPopup("picker", ImGuiWindowFlags_NoMove);
        if (IMGUI_COLOR_PICKER_OPEN)
        {
            ...
            ImGuiColorEditFlags picker_flags_to_forward = ImGuiColorEditFlags_NoDragDrop | ImGuiColorEditFlags__DataTypeMask | ImGuiColorEditFlags__PickerMask | ImGuiColorEditFlags_HDR | ImGuiColorEditFlags_NoAlpha | ImGuiColorEditFlags_AlphaBar;
