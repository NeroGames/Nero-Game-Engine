...
namespace nero
{
    ...
    class BackgroundTaskManager {
      public:
        ...
        // test template
        template <typename T>
        static void startTask(void (T::*callBack)(BackgroundTask::Ptr backgroundTask), T* parent, const std::string& taskName = StringPool.BLANK, const std::string& taskCategory = EngineConstant.DEFAULT_TASK_CATEGORY);

        template <typename T>
        static void                                    startTask(void (T::*callBack)(const Parameter& parameter, BackgroundTask::Ptr backgroundTask), T* parent, const Parameter& parameter, const std::string& taskName = StringPool.BLANK, const std::string& taskCategory = EngineConstant.DEFAULT_TASK_CATEGORY);
