...
namespace nero
{
    ...
    {
        public:
            enum    Type                            {None, Distance_Joint, Friction_Joint, Gear_Joint, Motor_Joint, Mouse_Joint, Prismatic_Joint, Pulley_Joint, Revolute_Joint, Rope_Joint, Weld_Joint, Wheel_Joint};
