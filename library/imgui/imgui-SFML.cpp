...
namespace ImGui
{
               ...
               const sf::Color&         borderColor)
    {
        ...
        GLuint      textureHandle = texture.getTexture().getNativeHandle();
        std::memcpy(&textureID, &textureHandle, sizeof(GLuint));
        ...
        ImGui::Image(textureID,
                     ...
                     ImVec2(1, 0), // flipped vertically, because textures in sf::RenderTexture are
                                   // stored this way
                     ImColor(static_cast<int>(tintColor.r),
                             static_cast<int>(tintColor.g),
                             static_cast<int>(tintColor.b),
                             static_cast<int>(tintColor.a)),
                     ImColor(static_cast<int>(borderColor.r),
                             static_cast<int>(borderColor.g),
                             static_cast<int>(borderColor.b),
                             static_cast<int>(borderColor.a)));
    }
    ...
    {
        sf::Vector2f textureSize = static_cast<sf::Vector2f>(texture.getSize());
        return ::imageButtonImpl(texture,
                                 sf::FloatRect(0.f, 0.f, textureSize.x, textureSize.y),
                                 size,
                                 framePadding,
                                 bgColor,
                                 tintColor);
...
namespace
{
                         ...
                         const sf::Color&     tintColor)
    {
        ...
        return ImGui::ImageButton((void*)texture.getNativeHandle(),
                                  size,
                                  uv0,
                                  uv1,
                                  framePadding,
