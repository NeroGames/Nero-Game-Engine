...
namespace ImGui
{
    ...
    IMGUI_API void          StyleColorsNero(ImGuiStyle* dst = NULL);    // Nero Game Engine color scheme
	...
	IMGUI_API bool          BeginPopupCanvasWindow(const char* str_id = NULL, int mouse_button = 1, bool also_over_items = true);  // helper to open and begin popup when clicked on current window.
...
enum ImGuiWindowFlags_
{
	...
	ImGuiWindowFlags_ScrollToolbar			= 1 << 22,  // Nero Game Engine, Scroll tool bar
...
enum ImGuiDockNodeFlags_
{
    ...
    ImGuiDockNodeFlags_SingleDock                   = 1 << 7
};
