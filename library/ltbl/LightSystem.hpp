...
namespace ltbl
{
    ...
    class LightSystem : sf::NonCopyable
    {
      public:
        ...
        /// Call it only if you change the penumbra texture or shaders, render texture size are
        /// automatically updated \param size The new size for render texture, don't call it with
        ...
        //////////////////////////////////////////////////////////////////////////
        /// \brief Set the Texture Factor for scaling down textures
        /// \param textureFactor The new texture factor
        //////////////////////////////////////////////////////////////////////////
        void                    setTextureFactor(float textureFactor);

      private:
        sf::Texture mPenumbraTexture; ///< The penumbra texture, loaded from memory when the system
                                      ///< is created
        sf::Shader
            mUnshadowShader; ///< The unshadow shader, loaded from memory when the system is created
        sf::Shader mLightOverShapeShader; ///< The light over shape shader, loaded from memory when
                                          ///< the system is created
        sf::Shader mNormalsShader;        ///< The normal shader

        priv::Quadtree mLightShapeQuadtree; ///< The quadtree which handles LightShape
        priv::Quadtree
            mLightPointEmissionQuadtree; ///< The quadtree which handles LightPointEmission

        std::unordered_set<LightPointEmission*>
            mPointEmissionLights; ///< The LightPointEmissions of the system
        std::unordered_set<LightDirectionEmission*>
            mDirectionEmissionLights;                 ///< The LightDirectionEmissions of the system
        ...
        float                           mTextureFactor;       ///< Factor for scaling down textures
