...
namespace nero
{
	...
	void AdvancedScene::createGameLevel(const Parameter& parameter)
	{
		//generate paratemers
	...
	void AdvancedScene::closeSelectedGameLevel()
	{
		//TODO
	}

	void AdvancedScene::removeGameLevel(const std::string& levelName)
	{
		//TODO
	}

	void AdvancedScene::registerGameLevel(const std::string& levelName)
	{
		//register level
	...
	void AdvancedScene::unregisterGameLevel(const std::string& levelName)
	{
	...
	void AdvancedScene::createGameScreen(const Parameter& parameter)
	{
	...
	std::vector<std::string> AdvancedScene::getRegisteredGameLevel()
	{
