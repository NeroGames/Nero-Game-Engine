...
namespace nero
{
    ...
    void ToolbarScrollButton::renderLeft()
    {
        ...
        ImGui::BeginChild("##toolbarscrollleft",
                          ImVec2(),
                          false,
        ...
        if(ImGui::Button("<<##toolbarscrollleftbutton", ImVec2(32.f, 38.f)))
        {
            if(m_ToolbarContentWindow)
            {
                ...
                float scroll_step =
                    ImFloor(ImMin(2 * m_ToolbarContentWindow->CalcFontSize(), max_step.x));
                ImGui::SetWindowScrollX(m_ToolbarContentWindow,
                                        m_ToolbarContentWindow->Scroll.x - 1 * scroll_step);
            }
        }
        ImGui::PopStyleColor();
    ...
    void ToolbarScrollButton::renderRight()
    {
        ...
        ImGui::PushStyleVar(ImGuiStyleVar_WindowPadding, ImVec2());
        ImGui::BeginChild("##toolbarscrollright",
                          ImVec2(),
                          false,
                          ImGuiWindowFlags_NoScrollbar | ImGuiWindowFlags_NoScrollWithMouse);
        ImGui::PushStyleColor(ImGuiCol_Button, ImVec4(0.260f, 0.590f, 0.980f, 1.000f));
